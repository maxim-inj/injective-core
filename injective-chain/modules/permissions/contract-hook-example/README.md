# Contract Hook contract examples
...
Source code for RestrictSpecificAddressTransferHook is located inside `solidity-contracts` repo. Abi is generated and copied using precompile-bindings shell script.
