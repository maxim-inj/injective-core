...
func ConvertExchangeProposal(
	...
	case *types.BatchExchangeModificationProposal:
		contentV2, err = ConvertBatchExchangeModificationProposalToV2(ctx, k, marketFinder, c)
	...
	case *types.BinaryOptionsMarketLaunchProposal:
		contentV2, err = convertBinaryOptionsMarketLaunchProposalToV2(ctx, k, c)
...
func ConvertBatchExchangeModificationProposalToV2(
	...
	v1Proposal *types.BatchExchangeModificationProposal,
...
func convertUpdateDenomMinNotionalProposalToV2(
	ctx sdk.Context, k *ProposalKeeper, v1Proposal *types.DenomMinNotionalProposal,
